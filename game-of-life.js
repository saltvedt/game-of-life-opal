...
Opal.modules["grid"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$width', '$height', '$draw_grid', '$add_mouse_event_listener', '$>=', '$context', '$+', '$each_with_index', '$==', '$fill_cell', '$unfill_cell', '$page_x', '$page_y', '$[]', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$-', '$new', '$*', '$on', '$get_cursor_position', '$x', '$y', '$push', '$seed', '$find', '$delete']);
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.height = $("#gridContainer").height();
      self.width = $("#gridContainer").width();
      self.canvas = document.getElementById(self.$canvas_id());
      self.context = self.$canvas().getContext('2d');
      self.max_x = ($rb_divide(self.$width(), $scope.get('CELL_WIDTH'))).$floor();
      self.max_y = ($rb_divide(self.$height(), $scope.get('CELL_HEIGHT'))).$floor();
      self.seed = [];
      self.$draw_grid();
      return self.$add_mouse_event_listener();
    });

    Opal.defn(self, '$draw_grid', function() {
    ...
    Opal.defn(self, '$redraw_canvas', function(s) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = s).$each_with_index, $a.$$p = (TMP_1 = function(row, x){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (row == null) row = nil;if (x == null) x = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_2 = function(cell, y){var self = TMP_2.$$s || this;
if (cell == null) cell = nil;if (y == null) y = nil;
        if (cell['$=='](1)) {
            return self.$fill_cell(x, y)
            } else {
            return self.$unfill_cell(x, y)
    ...
    return (Opal.defn(self, '$add_mouse_event_listener', function() {
      ...
      ($a = ($b = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_3 = function(event){var self = TMP_3.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1], $a;
        self.$fill_cell(x, y);
        return self.$seed().$push([x, y]);}, TMP_3.$$s = self, TMP_3), $a).call($b, "click");
      return ($a = ($c = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_4 = function(event){var self = TMP_4.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1], $a;
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_4.$$s = self, TMP_4), $a).call($c, "dblclick");
    }), nil) && 'add_mouse_event_listener';
  })($scope.base, null);
};
/* Generated by Opal 0.9.2 */
Opal.modules["interval"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$call', '$!', '$nil?']);
  return (function($base, $super) {
    function $Interval(){};
    ...
    def.ticker = def.time = def.interval = nil;
    Opal.defn(self, '$initialize', function(ticker, time) {
      var self = this;
    ...
    Opal.defn(self, '$resume', function() {
      var self = this;

      return self.interval = setInterval(function(){self.ticker.$call()}, self.time);
    });

    Opal.alias(self, 'start', 'resume');
    ...
    return (Opal.defn(self, '$running?', function() {
      var self = this;
...
Opal.modules["game-of-life"] = function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, game = nil;

  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$blank_state', '$add_button_event_listener', '$on', '$start_stop', '$find', '$nil?', '$load_seed', '$run', '$running?', '$stop', '$resume', '$new', '$max_y', '$grid', '$max_x', '$[]', '$state', '$%', '$[]=', '$each', '$set_state', '$seed', '$seed=', '$tick', '$start', '$state=', '$new_state', '$redraw_canvas', '$each_with_index', '$calculate_new_state_at', '$population_at', '$is_alive?', '$==', '$+', '$get_state', '$-']);
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("forwardable");
  self.$require("grid");
  self.$require("interval");
  (function($base, $super) {
    function $Game(){};
    ...
    Opal.defn(self, '$initialize', function(grid) {
      var self = this;

      self.grid = grid;
      self.state = self.$blank_state();
      return self.$add_button_event_listener();
    });

    Opal.defn(self, '$add_button_event_listener', function() {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = $scope.get('Element').$find("#start_stop")).$on, $a.$$p = (TMP_1 = function(event){var self = TMP_1.$$s || this;
if (event == null) event = nil;
      return self.$start_stop()}, TMP_1.$$s = self, TMP_1), $a).call($b, "click");
    });

    Opal.defn(self, '$start_stop', function() {
      var $a, self = this;

      if ((($a = self.interval['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$load_seed();
        return self.$run();
      } else if ((($a = self.interval['$running?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return self.interval.$stop()
        } else {
        return self.interval.$resume()
      };
    });

    Opal.defn(self, '$blank_state', function() {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, $b, TMP_3;

      return ($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return 0}, TMP_3.$$s = self, TMP_3), $a).call($b, self.$grid().$max_y())}, TMP_2.$$s = self, TMP_2), $a).call($b, self.$grid().$max_x());
    });

    Opal.defn(self, '$get_state', function(x, y) {
      var self = this;

      return self.$state()['$[]'](x['$%'](self.$grid().$max_x()))['$[]'](y['$%'](self.$grid().$max_y()));
    });

    Opal.defn(self, '$set_state', function(x, y, s) {
      var self = this;

      return self.$state()['$[]'](x)['$[]='](y, s);
    });

    Opal.defn(self, '$load_seed', function() {
      var $a, $b, TMP_4, $c, self = this;

      ($a = ($b = self.$grid().$seed()).$each, $a.$$p = (TMP_4 = function(x, y){var self = TMP_4.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
      return self.$set_state(x, y, 1)}, TMP_4.$$s = self, TMP_4), $a).call($b);
      return (($a = [[]]), $c = self.$grid(), $c['$seed='].apply($c, $a), $a[$a.length-1]);
    });

    Opal.defn(self, '$run', function() {
      var $a, $b, TMP_5, self = this, ticker = nil;

      ticker = ($a = ($b = $scope.get('Proc')).$new, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

      return self.$tick()}, TMP_5.$$s = self, TMP_5), $a).call($b);
      self.interval = $scope.get('Interval').$new(ticker);
      return self.interval.$start();
    });

    Opal.defn(self, '$tick', function() {
      var $a, $b, self = this;

      (($a = [self.$new_state()]), $b = self, $b['$state='].apply($b, $a), $a[$a.length-1]);
      return self.$grid().$redraw_canvas(self.$state());
    });

    Opal.defn(self, '$new_state', function() {
      var $a, $b, TMP_6, self = this, new_state = nil;

      new_state = self.$blank_state();
      ($a = ($b = self.$state()).$each_with_index, $a.$$p = (TMP_6 = function(row, x){var self = TMP_6.$$s || this, $a, $b, TMP_7;
if (row == null) row = nil;if (x == null) x = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_7 = function(_, y){var self = TMP_7.$$s || this;
if (_ == null) _ = nil;if (y == null) y = nil;
        return new_state['$[]'](x)['$[]='](y, self.$calculate_new_state_at(x, y))}, TMP_7.$$s = self, TMP_7), $a).call($b)}, TMP_6.$$s = self, TMP_6), $a).call($b);
      return new_state;
    });

    Opal.defn(self, '$calculate_new_state_at', function(x, y) {
      var $a, $b, self = this, pop = nil;

      pop = self.$population_at(x, y);
      if ((($a = self['$is_alive?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = ((($b = pop['$=='](2)) !== false && $b !== nil) ? $b : pop['$=='](3))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return 1}
      } else if (pop['$=='](3)) {
        return 1};
      return 0;
    ...
    return (Opal.defn(self, '$is_alive?', function(x, y) {
      var self = this;

      return self.$get_state(x, y)['$=='](1);
    }), nil) && 'is_alive?';
  })($scope.base, null);
  return game = $scope.get('Game').$new($scope.get('Grid').$new());
};
